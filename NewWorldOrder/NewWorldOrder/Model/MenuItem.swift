...
let AllMenuItems: [(String, [MenuItem])] = [
    ...
    ("Breakfast",
     [MenuItem(title: "Breakfast Burrito", price: 8.75, image: "matcha", ingredients: "Tortilla, Avocados, Tomatoes, Mushrooms, Shallots, Garlic, Lime Juice, Eggs, Sausage, Monterey Jack Cheese, Seasonings (Cumin, Cilantro, Salt, Pepper)"),
      MenuItem(title: "Breakfast Sandwich", price: 8.75, image: "matcha", ingredients: "Croissant, Bacon, Eggs, Mushrooms, American Cheese, Avocados, Seasonings (Salt, Pepper)"),
    ...
    ("Sandwiches",
     [MenuItem(title: "Pesto Chicken", price: 9.75, image: "matcha", ingredients: "Bread Rolls, Chicken, Mozzarella Slices, Tomatoes, Pesto"),
      ...
      MenuItem(title: "Turkey Swiss", price: 8.50, image: "matcha", ingredients: "French Bread, Roast Turkey, Swiss Cheese, Tomatoes, Onion, Mustard, Mayo"),
    ...
    ("Salads",
     [MenuItem(title: "Peanut Kale", price: 9.50, image: "matcha", ingredients: "Kale, Onions, Garlic, Peanut Butter, Rice Vinegar, Tamari, Rice Syrup, Honey"),
      MenuItem(title: "Caprese", price: 9.50, image: "matcha", ingredients: "Basil, Tomatoes, Mozerella, Balsamic Vinegar, Olive Oil"),
      MenuItem(title: "Asian Chicken", price: 10.00, image: "matcha", ingredients: "Cabbage, Lettuce, Shredded Chicken, Carrots, Red Peppers, Shallots, Rice Vinegar, Soy Sauce, Garlic, Sesame Oil, Sesame Seeds, Mandarin Oranges"),
      MenuItem(title: "Cranberry Walnut", price: 9.00, image: "matcha", ingredients: "Lettuce, Spinach, Walnuts, Red Onion, Cranberries, Goat Cheese, Balsamic Vinaigrette"),
     ]
    ),
    ("Dinner",
